...
<svg xmlns="http://www.w3.org/2000/svg" width="460" height="120" viewBox="0 0 460 120">
  <rect width="460" height="120" rx="14" fill="#fff8ea"/>
  <rect x="1.5" y="1.5" width="457" height="117" rx="13" fill="none" stroke="#c8945d" stroke-width="3"/>
...
function renderPageViewSvg({ courseLabel, lessonLabel, last24h, last7d, updatedAt }) {
  return `
<svg xmlns="http://www.w3.org/2000/svg" width="460" height="120" viewBox="0 0 460 120">
  <rect width="460" height="120" rx="14" fill="#edf7f6"/>
  <rect x="1.5" y="1.5" width="457" height="117" rx="13" fill="none" stroke="#4d9a9c" stroke-width="3"/>
